var HomeLayer = cc.Layer.extend({
	...
	tableCellAtIndex:function (table, idx) {
		...
		if (!cell) {
			...
			labelCellBox = new cc.LabelBMFont(this.arrayCategories[parseInt(strValue)], res.fntmasSulit32_fnt);
			labelCellBox.attr({
			...
			labelCellBox.setString(this.arrayCategories[parseInt(strValue)]);
		}
